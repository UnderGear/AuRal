...
public class PointGeoSynth extends GeoSynth {
	...
	//constructor
	public PointGeoSynth(double lat, double lon, int index, String syn, String name, boolean server) {
		this.lat = lat;
		this.lon = lon;
		this.index = index;
		this.synthDef = syn;
		...
		setOverlayItem(new OverlayItem(p, name, syn));
	}
